  ...
  return {
    ...
    branches: [
      ...
      },
      {
        id: heartId,
        paragraphs: [
          `${seed.characterEn} paused beside a worried friend who no longer knew which bridge marker to follow.`,
          `After listening carefully, they noticed a hidden bridge with only one lit sign still working.`,
          `They now had to choose: cross immediately, or guide the others to the safe marker first.`,
        ],
        paragraphsTr: [
          `${seed.characterTr}, hangi köprü işaretini izleyeceğini şaşırmış endişeli bir dostun yanında durdu.`,
          `Dikkatle bakınca, yalnızca tek lambası yanan gizli bir köprü işareti fark ettiler.`,
          `Şimdi karar vermeleri gerekiyordu: hemen geçmek mi, yoksa önce diğerlerini güvenli işarete yönlendirmek mi?`,
        ],
        choices: [
          {
            ...
            consequence: 'Carry the lamp together and reach the far side safely.',
            consequenceTr: 'Lambayı birlikte taşıyıp karşıya güvenle geç.',
          },
          {
            ...
            consequence: 'Mark the safe route before anyone moves.',
            consequenceTr: 'Kimse ilerlemeden önce güvenli rotayı işaretle.',
          },
        ],
      },
      {
